        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category, index) => (
            <FadeIn key={category.title} delay={0.1 * index}>
              <div className="group p-8 rounded-3xl bg-white/50 backdrop-blur-sm border border-black/10 hover:border-black/20 hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105">
